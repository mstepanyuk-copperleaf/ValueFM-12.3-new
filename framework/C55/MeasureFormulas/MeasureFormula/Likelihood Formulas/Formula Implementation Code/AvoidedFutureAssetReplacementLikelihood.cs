...
namespace CustomerFormulaCode
{
    ...
    public class AvoidedFutureAssetReplacementLikelihood : AvoidedFutureAssetReplacementLikelihoodBase
    {
            ...
            TimeInvariantInputDTO timeInvariantData, IReadOnlyList<TimeVariantInputDTO> timeVariantData)
        {
		    ...
		    var endMonth = Math.Min(months, firstMonth + CommonConstants.MonthsPerYearInt * timeInvariantData.Years_32_to_32_Certain_32_Replacement);

            for (var i = Math.Max(0, firstMonth); i < endMonth; i++)
			{
				annualProbabilities[i] = 1d / timeInvariantData.Years_32_to_32_Certain_32_Replacement;
			}
