...
namespace CustomerFormulaCode
{
    ...
    public class HSPublicMinorInjuries : HSPublicMinorInjuriesBase
    {
        ...
        {
            if (timeInvariantData.Probability_32_of_32_member_32_of_32_public_32_minor_32_injury == null){
    		...
    		double MinorInjuryProb = timeInvariantData.Probability_32_of_32_member_32_of_32_public_32_minor_32_injury ?? 0;
