...
namespace CustomerFormulaCode
{
    ...
    public class ResValAssetAge : ResValAssetAgeBase
    {
            ...
            TimeInvariantInputDTO timeInvariantData, IReadOnlyList<TimeVariantInputDTO> timeVariantData)
        {
		    ...
		    {
    			AssetInServiceYear = timeInvariantData.AlternativeStartDate.Month < CustomerConstants.AssetStartDateMonthOffset ? timeInvariantData.AlternativeStartDate.Year - 1: timeInvariantData.AlternativeStartDate.Year;
    		} else
		    {
