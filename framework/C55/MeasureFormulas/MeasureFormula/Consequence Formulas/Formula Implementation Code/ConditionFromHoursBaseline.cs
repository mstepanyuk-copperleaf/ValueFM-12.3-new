...
namespace CustomerFormulaCode
{
    ...
    public class ConditionFromHoursBaseline : ConditionFromHoursBaselineBase
    {
        ...
        {
    		if (timeInvariantData.AssetOperating_32_Hours == null || timeInvariantData.AssetOpHrsDate == null || 
                timeInvariantData.AssetExpected_32_Annual_32_Operating_32_Hours == null)
    		{
    			return null;
    		}
            ...
            var monthlyExpectedOperatingHours = timeInvariantData.AssetExpected_32_Annual_32_Operating_32_Hours /
                                                CommonConstants.MonthsPerYear;
            double? initialOperatingHours = timeInvariantData.AssetOperating_32_Hours;
