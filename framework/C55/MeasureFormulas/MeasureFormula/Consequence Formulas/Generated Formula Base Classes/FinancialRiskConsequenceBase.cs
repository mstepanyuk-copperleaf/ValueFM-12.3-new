    ...
    public abstract class FinancialRiskConsequenceBase : FormulaConsequenceBase
    {
        ...
        public class TimeVariantInputDTO : ITimeVariantInputDTO
        {
            public TimeVariantInputDTO(
                System.Int64 p_Dollar_32_Consequence_32_Amount,
                CL.FormulaHelper.DTOs.TimePeriodDTO p_TimePeriod)
            {
                Dollar_32_Consequence_32_Amount = p_Dollar_32_Consequence_32_Amount;
                TimePeriod = p_TimePeriod;
            }
            
            [PromptInput("Dollar Consequence Amount")]
            [DataMember]
            public System.Int64 Dollar_32_Consequence_32_Amount  { get; private set; }
