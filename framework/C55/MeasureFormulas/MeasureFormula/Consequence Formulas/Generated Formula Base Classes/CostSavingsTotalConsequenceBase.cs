    ...
    public abstract class CostSavingsTotalConsequenceBase : FormulaConsequenceBase
    {
        ...
        public class TimeVariantInputDTO : ITimeVariantInputDTO
        {
            public TimeVariantInputDTO(
                System.Int64 p_Costs_32_Saved,
                System.Double p_Hours_32_Saved,
                CL.FormulaHelper.DTOs.TimePeriodDTO p_TimePeriod)
            {
                Costs_32_Saved = p_Costs_32_Saved;
                Hours_32_Saved = p_Hours_32_Saved;
                TimePeriod = p_TimePeriod;
            }
            
            [PromptInput("Costs Saved")]
            [DataMember]
            public System.Int64 Costs_32_Saved  { get; private set; }
            
            [PromptInput("Hours Saved")]
            [DataMember]
            public System.Double Hours_32_Saved  { get; private set; }
