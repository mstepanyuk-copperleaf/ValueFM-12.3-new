    ...
    public abstract class VVOEnergySavingsConsequenceBase : FormulaConsequenceBase
    {
        ...
        public class TimeInvariantInputDTO
        {
            public TimeInvariantInputDTO(
                System.Double?[] p_Energy_32_Efficiency_Energy_32_Savings_32_Total_ConsqUnitOutput,
                System.Boolean p_VVO)
            {
                Energy_32_Efficiency_Energy_32_Savings_32_Total_ConsqUnitOutput = p_Energy_32_Efficiency_Energy_32_Savings_32_Total_ConsqUnitOutput;
                VVO = p_VVO;
            }
            
            [MeasureInput("Energy Efficiency", "Energy Savings Total", MeasureOutputType.ConsqUnitOutput, false)]
            [DataMember]
            public System.Double?[] Energy_32_Efficiency_Energy_32_Savings_32_Total_ConsqUnitOutput  { get; private set; }
