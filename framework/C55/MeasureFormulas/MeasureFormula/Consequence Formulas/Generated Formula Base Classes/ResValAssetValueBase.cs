    ...
    public abstract class ResValAssetValueBase : FormulaConsequenceBase
    {
        ...
        public class TimeInvariantInputDTO
        {
            public TimeInvariantInputDTO(
                ...
                System.Double?[] p_Residual_32_value_Asset_32_effective_32_age_ConsqUnitOutput)
            {
                AssetBookAge = p_AssetBookAge;
                AssetValue = p_AssetValue;
                Residual_32_value_Asset_32_effective_32_age_ConsqUnitOutput = p_Residual_32_value_Asset_32_effective_32_age_ConsqUnitOutput;
            }
            ...
            [MeasureInput("Residual value", "Asset effective age", MeasureOutputType.ConsqUnitOutput, false)]
            [DataMember]
            public System.Double?[] Residual_32_value_Asset_32_effective_32_age_ConsqUnitOutput  { get; private set; }
        }
