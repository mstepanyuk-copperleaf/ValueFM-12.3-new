    ...
    public abstract class CustomerCostSavingsConsequenceBase : FormulaConsequenceBase
    {
        ...
        public class TimeVariantInputDTO : ITimeVariantInputDTO
        {
            public TimeVariantInputDTO(
                System.Int32 p_Customer_32_Cost_32_Savings,
                CL.FormulaHelper.DTOs.TimePeriodDTO p_TimePeriod)
            {
                Customer_32_Cost_32_Savings = p_Customer_32_Cost_32_Savings;
                TimePeriod = p_TimePeriod;
            }
            
            [PromptInput("Customer Cost Savings")]
            [DataMember]
            public System.Int32 Customer_32_Cost_32_Savings  { get; private set; }
