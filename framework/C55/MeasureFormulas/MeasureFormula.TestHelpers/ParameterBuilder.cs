...
namespace MeasureFormula.TestHelpers
{
    ...
    public static class ParameterBuilder
    {
        ...
        static ParameterBuilder()
        {
            ...
            AddToDictionary(Parameter.SystemCustomerTairConsequence, "p_SystemCustomer_32_TAIR_32_Consequence");
            AddToDictionary(Parameter.AccountType, "p_Account_32_Type");
