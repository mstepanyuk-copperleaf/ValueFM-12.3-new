...
namespace MeasureFormula.Tests
{
    public class SimpleAssetConditionalProbabilityOutcomeAATest : MeasureFormulaTestsBase
    {
        ...
        public void FixtureSetup()
        {
            ...
            TimeVariantData = BuildSimpleTimeVariantData(fixture, 1, SurveyDate );
        }
        ...
        private static baseClass.TimeVariantInputDTO[] BuildSimpleTimeVariantData(Fixture fixture, int periods, int startYear)
        {
            var startYearInThePast = startYear;
            const int monthOffsetFromFiscalYearEnd = 3;
            var timePeriodsStartingBeforeToday =
                DataPrep.BuildContiguousTimePeriodsStartYearAndOffset(fixture,
                                                                      periods,
                                                                      startYearInThePast,
                                                                      monthOffsetFromFiscalYearEnd);
            fixture.Customizations.Insert(0, new TimePeriodExtractor(timePeriodsStartingBeforeToday));
            
            var generatedTimeVariantDto = fixture.CreateMany<baseClass.TimeVariantInputDTO>(periods).ToArray();
