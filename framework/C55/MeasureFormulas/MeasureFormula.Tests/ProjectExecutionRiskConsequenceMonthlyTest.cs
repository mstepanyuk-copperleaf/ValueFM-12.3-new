...
namespace MeasureFormula.Tests
{
    public class ProjectExecutionRiskConsequenceMonthlyTest : MeasureFormulaTestsBase
    {
        ...
        {
            DataPrep.SetConstructorParameter(fixture, "p_Are_32_Initial_32_Effort_32_and_32_Schedule_32_Realistic", effortScheduleRealistic);
            DataPrep.SetConstructorParameter(fixture, "p_How_32_Well_32_Defined_32_will_32_Project_32_Scope_32_be", definedProjectScope);
            DataPrep.SetConstructorParameter(fixture, "p_InvestmentSpendByAccountType", investmentSpendAccount);
            DataPrep.SetConstructorParameter(fixture, "p_Lining_32_up_32_Right_32_Implementation_32_Partners", implementationPartners);
            DataPrep.SetConstructorParameter(fixture, "p_Methodology_32_and_32_Track_32_Record", methodTrackRecord);
            DataPrep.SetConstructorParameter(fixture, "p_PM_39_s_32_Previous_32_Experience", previousExperience);
            DataPrep.SetConstructorParameter(fixture, "p_Proven_32_Implementation_32_Methodology", implementationMethodology);
            DataPrep.SetConstructorParameter(fixture, "p_Skills_32_to_32_Manage_32_the_32_Project", skillsManagementProject);
            DataPrep.SetConstructorParameter(fixture, "p_Team_39_s_32_Right_32_Internal_32_Skillset", teamSkillset);
            DataPrep.SetConstructorParameter(fixture, "p_Type_32_of_32_Contract", contracts);
            DataPrep.SetConstructorParameter(fixture, "p_Vendor_32_Industry_32_Experience", vendorIndustExperience);
            DataPrep.SetConstructorParameter(fixture, "p_Vendor_32_Technical_32_Experience", vendorTechExperience);
        }
