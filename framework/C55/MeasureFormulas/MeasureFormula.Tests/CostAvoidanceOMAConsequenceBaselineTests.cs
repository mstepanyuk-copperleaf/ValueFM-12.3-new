...
namespace MeasureFormula.Tests
{
    ...
    public class CostAvoidanceOMAConsequenceBaselineTests : MeasureFormulaTestsBase
    {
        ...
        public void NullTests()
        {
            ...
            var correctAccount = fixture.Build<CustomFieldListItemDTO>().With(x=>x.Value, CustomerConstants.OMAAcctID).Create();
            DataPrep.SetConstructorParameter(fixture, "p_Account_32_Type", correctAccount);
