...
namespace MeasureFormula.Tests
{
    public class CostAvoidanceOMAConsequenceOutcomeTest : MeasureFormulaTestsBase
    {
        ...
        {
            DataPrep.SetConstructorParameter(fixture, "p_Costs_32_incurred_32_after_32_this_32_investment_32_is_32_undertaken", incurredInvestmentCost);
            DataPrep.SetConstructorParameter(fixture, "p_Hours_32_incurred_32_if_32_this_32_investment_32_is_32_undertaken", incurredInvestmentHours);
        ...
        {
            var wrongAccountNumber = CustomerConstants.OMAAcctID + 1;
            var wrongAccountOMAID = fixture.Create<CustomFieldListItemDTO>();
            DataPrep.UpdateDto(wrongAccountOMAID, "Value", wrongAccountNumber);
            DataPrep.SetConstructorParameter(fixture, "p_Account_32_Type", wrongAccountOMAID);
