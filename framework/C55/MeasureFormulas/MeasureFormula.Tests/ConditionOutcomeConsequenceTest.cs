...
namespace MeasureFormula.Tests
{
    public class ConditionOutcomeConsequenceTest : MeasureFormulaTestsBase
    {
        ...
        public void NullTests_GetUnits_ReturnsNull()
        {
            ...
            nullCheck.RunNullTestsIncludingCustomFields(TimeInvariantData, SingleTimeVariantData, getUnitsCall);
        }
        ...
        public void NullAssetImpactedByAlternative_GetUnits_ReturnsNull()
        {
            ...
            var results = Formulas.GetUnits(ArbitraryStartYear, ArbitraryMonths, nullImpactByAlternativeDto, SingleTimeVariantData);
